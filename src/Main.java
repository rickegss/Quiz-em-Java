public class Main {
    public static void main(String[] args) {
        ...
        Questao[] questoes = {
                new Questao("Qual é o planeta do Sistema Solar que tem o dia mais curto?", "Júpiter", "Mercúrio", "Terra", "Marte", "Netuno", "B"),
                new Questao("Qual fenômeno ocorre quando a Terra fica entre o Sol e a Lua, projetando sua sombra sobre a Lua?", "Eclipse Solar", "Eclipse Lunar", "Solstício", "Equinácio", "Supernova", "B"),
